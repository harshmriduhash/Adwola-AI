...
cat > ~/.claude/commands/adwola/commit.md << 'EOF'
---
...
cat > ~/.claude/commands/adwola/feature-branch.md << 'EOF'
---
...
cat > ~/.claude/commands/adwola/supabase.md << 'EOF'
---
...
cat > ~/.claude/commands/adwola/qa.md << 'EOF'
---
...
cat > ~/.claude/commands/adwola/analytics.md << 'EOF'
---
...
cat > ~/.claude/commands/adwola/deploy.md << 'EOF'
---
...
cat > ~/.claude/commands/adwola/status.md << 'EOF'
---
