...
export function AnimatedTestimonialsCarousel() {
  ...
  const prevTestimonial = () => {
    setCurrentIndex(
      (prev) =>
        (prev - 1 + carouselTestimonials.length) % carouselTestimonials.length
    );
    setIsAutoPlaying(false);
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div ref={headerRef} className="text-center mb-20">
          ...
          >
            ...
            about transforming their content strategy with AmplifyAI.
          </motion.p>
        </div>
        ...
        <div className="relative">
          ...
          >
            <motion.div
              ...
              role="group"
              aria-live="polite"
              aria-label={`Testimonial ${currentIndex + 1} of ${
