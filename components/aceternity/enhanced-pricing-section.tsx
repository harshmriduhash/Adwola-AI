...
const pricingPlans = [
	{
		...
		bgGradient: "from-gray-50/50 to-gray-100/50 dark:from-gray-800/50 dark:to-gray-900/50",
		features: [
	...
	},
	{
		...
		features: [
			...
			{ name: "Advanced AI content generation", included: true, highlight: true },
	...
	},
	{
		...
		features: [
			...
			{ name: "Advanced AI content generation", included: true, highlight: false },
...
function PricingCard({ plan, index, isAnnual, isComparing, onCompare }: {
						...
						<ul className="space-y-3">
							{plan.features.map((feature, featureIndex) => (
								<motion.li
									...
									transition={{ delay: index * 0.2 + featureIndex * 0.05 + 0.5 }}
					...
					>
						<span
							className={cn(
								...
								!isAnnual ? "text-blue-600 dark:text-blue-400" : "text-muted-foreground"
							)}
						>
							Monthly
						</span>
