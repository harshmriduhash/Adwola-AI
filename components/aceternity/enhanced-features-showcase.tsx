...
const getColorClasses = (color: string) => {
	const colors = {
		blue: {
			...
			badge: "bg-blue-100/80 text-blue-700 dark:bg-blue-900/50 dark:text-blue-300 border-blue-200 dark:border-blue-800",
			glow: "shadow-blue-500/20",
		},
		purple: {
			bg: "bg-purple-100 dark:bg-purple-900/50",
			text: "text-purple-600 dark:text-purple-400",
			badge: "bg-purple-100/80 text-purple-700 dark:bg-purple-900/50 dark:text-purple-300 border-purple-200 dark:border-purple-800",
			glow: "shadow-purple-500/20",
		},
		green: {
			bg: "bg-green-100 dark:bg-green-900/50",
			text: "text-green-600 dark:text-green-400",
			badge: "bg-green-100/80 text-green-700 dark:bg-green-900/50 dark:text-green-300 border-green-200 dark:border-green-800",
			glow: "shadow-green-500/20",
		},
		orange: {
			bg: "bg-orange-100 dark:bg-orange-900/50",
			text: "text-orange-600 dark:text-orange-400",
			badge: "bg-orange-100/80 text-orange-700 dark:bg-orange-900/50 dark:text-orange-300 border-orange-200 dark:border-orange-800",
			glow: "shadow-orange-500/20",
		},
		pink: {
			bg: "bg-pink-100 dark:bg-pink-900/50",
			text: "text-pink-600 dark:text-pink-400",
			badge: "bg-pink-100/80 text-pink-700 dark:bg-pink-900/50 dark:text-pink-300 border-pink-200 dark:border-pink-800",
			glow: "shadow-pink-500/20",
		},
		indigo: {
			bg: "bg-indigo-100 dark:bg-indigo-900/50",
			text: "text-indigo-600 dark:text-indigo-400",
			badge: "bg-indigo-100/80 text-indigo-700 dark:bg-indigo-900/50 dark:text-indigo-300 border-indigo-200 dark:border-indigo-800",
			glow: "shadow-indigo-500/20",
		},
		red: {
			bg: "bg-red-100 dark:bg-red-900/50",
			text: "text-red-600 dark:text-red-400",
			badge: "bg-red-100/80 text-red-700 dark:bg-red-900/50 dark:text-red-300 border-red-200 dark:border-red-800",
			glow: "shadow-red-500/20",
		},
		teal: {
			bg: "bg-teal-100 dark:bg-teal-900/50",
			text: "text-teal-600 dark:text-teal-400",
			badge: "bg-teal-100/80 text-teal-700 dark:bg-teal-900/50 dark:text-teal-300 border-teal-200 dark:border-teal-800",
			glow: "shadow-teal-500/20",
		},
		cyan: {
			bg: "bg-cyan-100 dark:bg-cyan-900/50",
			text: "text-cyan-600 dark:text-cyan-400",
			badge: "bg-cyan-100/80 text-cyan-700 dark:bg-cyan-900/50 dark:text-cyan-300 border-cyan-200 dark:border-cyan-800",
...
function StatsCard({ icon: Icon, title, description, gradient, delay }: {
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
				...
				<div ref={headerRef} className="text-center mb-20">
					<motion.div
						...
						transition={{ duration: 0.6 }}
					>
						<Badge variant="secondary" className="mb-4 px-4 py-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg border border-white/20 dark:border-gray-700/30">
							<TrendingUp className="w-4 h-4 mr-2" />
							Enterprise Features
						</Badge>
					</motion.div>
