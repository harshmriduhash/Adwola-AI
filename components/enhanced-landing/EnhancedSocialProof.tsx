  ...
  const testimonials = [
    {
      ...
      avatar:
        "https://images.unsplash.com/photo-1494790108755-2616b612b589?w=150&h=150&fit=crop&crop=face",
      rating: 5,
      content:
        "Adwola completely transformed our content strategy. We went from struggling to post consistently to having a month's worth of high-quality content ready in just one afternoon. The AI understands our brand voice perfectly.",
      verified: true,
      metric: {
    ...
    },
    {
      ...
      rating: 5,
      content:
        "As a solo creator managing multiple clients, Adwola is a game-changer. The dual AI system gives me the creative edge I need while the scheduling feature handles the grunt work. My clients love the consistent quality.",
      verified: true,
      metric: {
        label: "Time Saved",
        value: "30hrs/week",
    ...
    },
    {
      ...
      rating: 5,
      content:
        "The analytics and performance insights are incredible. We can now predict which content will perform best before we even publish it. Our clients' ROI has improved dramatically since we started using Adwola.",
      verified: true,
      metric: {
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center space-x-4 mb-6">
            ...
            <span className="text-gray-600">
              from {ratings.total.toLocaleString()} reviews
            </span>
          </div>

          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Join thousands of creators who&apos;ve transformed their content
            strategy and achieved remarkable results
          </p>
        </div>
